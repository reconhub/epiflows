...
#' @param pop_country population of the infectious country
#' @param annual_travellers_to_other_countries annual number of travellers from
#' infectious country to other countries
#' @param annual_travellers_from_other_countries annual number of travellers
#' from other countries to the infectious country
...
fn_number_cases_spread <- function(time_window_days,
                                   num_infec_cases_in_time_window,
                                   pop_country,
                                   annual_travellers_to_other_countries,
                                   annual_travellers_from_other_countries,
